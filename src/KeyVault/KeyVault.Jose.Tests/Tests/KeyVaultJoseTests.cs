...
{
    public class KeyVaultJoseTests
    {
        static RNGCryptoServiceProvider _rng = new RNGCryptoServiceProvider();

        [Fact]
        public async Task KeyVault_Jose_TestDirectModeCompatibility()
        {
        ...
        [Fact]
        public async Task KeyVault_Jose_TestWrappingModeCompatibility()
        {
            // Create a key resolver and add the key
            var resolver = new SimpleKeyResolver();
        ...
        [Fact]
        public async Task KeyVault_Jose_TestDirectMode()
        {
            // Create a Symmetric key wrapper for the key material
            var key = CreateRandomKey("AesKey");
        ...
        [Fact]
        public async Task KeyVault_Jose_TestWrappingMode_Implicit()
        {
        ...
        [Fact]
        public async Task KeyVault_Jose_TestWrappingMode_Explicit()
        {
            // Create some plaintext
            var plaintext = new byte[256];
            _rng.GetNonZeroBytes( plaintext );
        ...
        [Fact]
        public async Task KeyVault_Jose_TestKeyNotFound()
        {
            // Create a key that will not be found, and protects some content with it.
            var key = CreateRandomKey( "Unknown" );
        ...
        */
        ...
        public async Task KeyVault_Jose_TestMalformedJwe()
        {
            ...
            {
                Console.WriteLine( "Testing component " + i + "..." );
        ...
        private static SymmetricKey CreateRandomKey( string name )
        {
            // Create some key material
            ...
            // Create an Symmetric key wrapper for the key material
            return new SymmetricKey( name, keyMaterial );
        }

        private static async Task<Tuple<string, SymmetricKey>> CreateRandomJweAsync( )
        {
            // Create random key.
            var key = CreateRandomKey( "123" );
